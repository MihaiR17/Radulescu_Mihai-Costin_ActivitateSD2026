...
void filtreazaHeap(Heap heap, int pozitieNod) {
	...
	if (pozStanga<heap.nrMasini && heap.vector[pozMax].pret < heap.vector[pozStanga].pret)
	{
		pozMax = pozStanga;
	}
	if (pozDreapta<heap.nrMasini && heap.vector[pozMax].pret < heap.vector[pozDreapta].pret)
	{
		pozMax = pozDreapta;
	}
