...
//	m.id=atoi(strtok(buffer, sep)); //ATOI=ASCII TO INTEGER ,STRTOK RETURNEAZA CHAR
//	m.nrUsi = atoi(strtok(NULL, sep));
//	m.pret = atof(strtok(NULL, sep));//ATOF=ASCII TO FLOAT
//	char* aux;
//	aux = strtok(NULL, sep);
...
//		if (m.model != NULL) {  // sau alt check valid
